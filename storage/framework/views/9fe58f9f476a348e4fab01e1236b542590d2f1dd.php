                        ...
                        <li><a href="#withdraw" aria-expanded="false" data-toggle="collapse"> <i
                            ...
                            <ul id="withdraw" class="collapse list-unstyled ">
                                <li id="withdraw-list-menu"><a
                                        href="<?php echo e(route('withdraw.index')); ?>"><?php echo e(trans('file.Withdraw List')); ?></a>
                                </li>
                                <?php
                                $add_permission = DB::table('permissions')
                        ...
                        <li><a href="#referral" aria-expanded="false" data-toggle="collapse"> <i
                            ...
                            <ul id="referral" class="collapse list-unstyled ">
                                <li id="referral-list-menu"><a
                                        href="<?php echo e(route('referral.index')); ?>"><?php echo e(trans('file.Referral List')); ?></a>
                                </li>
...
<?php /**PATH /home/jbgz9206/test.magasinette.ma/resources/views/layout/main.blade.php ENDPATH**/ ?>